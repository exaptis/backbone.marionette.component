...
define('lib/component/validation/ValidationError',['i18n', 'underscore.string'], function(i18n) {
  ...
  ValidationError = (function(_super) {
    ...
    ValidationError.prototype.updateErrorMessage = function() {
      return this.set('errorMessage', i18n.t(this.getErrorKey(), this.getErrorValues(), {
        silent: true
      }));
    };
...
define('lib/component/form/SubmitButton',['lib/component/Component', 'lib/component/form/Button'], function() {
  
  var SubmitButton, _base, _base1;
  SubmitButton = (function(_super) {
    __extends(SubmitButton, _super);

    function SubmitButton(componentId) {
      this.componentId = componentId;
      SubmitButton.__super__.constructor.call(this, this.componentId, (function(_this) {
        return function(event) {
          var form;
          event.preventDefault();
          form = _this.getParent();
          return form.process();
        };
      })(this));
    }
  ...
  })(Backbone.Marionette.Component.Button);
  (_base = Backbone.Marionette).Component || (_base.Component = {});
  return (_base1 = Backbone.Marionette.Component).SubmitButton || (_base1.SubmitButton = SubmitButton);
});
...
define('lib/component/Form',['lib/component/Component', 'lib/component/utils/ComponentStore'], function() {
  ...
  Form = (function(_super) {
    ...
    Form.prototype.render = function() {
      ...
      return form.on('submit', this.process);
    };
