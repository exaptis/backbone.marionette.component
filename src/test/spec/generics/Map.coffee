define [
  ...
  describe 'Map', ->
    ...
    it 'should be empty after initialization', ->
      expect(TEST_MAP.isEmpty()).to.be.equal true
    ...
    it 'should return the keys of the map', ->
      ...
      expect(mapKeys).to.be.deep.equal [TEST_ID_1, TEST_ID_2]
    ...
    it 'should return the values of the map', ->
      ...
      expect(mapValues).to.be.deep.equal [TEST_OBJECT_1, TEST_OBJECT_2]
    ...
    it 'should verify the presence of an object', ->
      ...
      #then
      expect(TEST_MAP.has(TEST_ID_1)).to.be.equal true
      expect(TEST_MAP.has(TEST_ID_2)).to.be.equal false
    ...
    it 'should iterate through the map', ->
      ...
      #then
      expect(results).to.be.deep.equal [TEST_OBJECT_1, TEST_OBJECT_2]
